export const messages = {
  ru: {
    ...
    home: {
      ...
      premises: [
        'Правила просты: у нас есть два Ethereum кошелька на этом сайте — один для ставок на то, что Минтер — не скам, второй на то, что Минтер — скам. Участники шлют деньги на один из этих адресов для ставок на цену BIP, будет она выне (не скам) или ниже (скам) цены ICO в $0.06 за 1 BIP на момент 10 января 2021.',
