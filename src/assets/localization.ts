  ...
  ru: {
    ...
    home: {
      ...
      premises: [
        ...
        'Победители получают их ставки назад и часть ставок проигравших, пропорциональную ставкам победителей. В случае, если курс BIP невозможно определить на состояние 10 января 2021, все ставки возвращаются к участникам, за вычетом комиссий на перевод сети Ethereum.',
